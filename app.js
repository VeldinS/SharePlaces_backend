...
const usersRoutes = require('./routes/users-routes')        //IMPORTING ROUTES
...
app.use('/api/places', placesRoutes); //to route only to places
app.use('/api/users', usersRoutes); //to route only to USERS
